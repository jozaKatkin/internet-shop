    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'Processing'), (2, 'Waiting to pick up for delivery'), (3, 'In delivery'), (4, 'Delivered'), (5, 'Cancelled')], default=1)),
                ('items', models.ManyToManyField(to='core.ItemInOrder')),
